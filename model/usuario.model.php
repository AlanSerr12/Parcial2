...
class UsuariosModel
{
    public function login($nombre, $contraseña)
    {
        ...
        $cadena = "SELECT usuario.* FROM usuario INNER JOIN Usuarios_Roles on usuario.idUsaurio = Usuarios_Roles.idUsuario INNER JOIN roles on Usuarios_Roles.idRoles = roles.idRoles WHERE correo = '$nombre' and contrasenia='$contraseña'";
        print $cadena;
